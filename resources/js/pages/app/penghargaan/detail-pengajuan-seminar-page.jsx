...
export default function DetailPengajuanSeminarPage() {
                    ...
                    <Table className="w-full">
                        <TableBody>
                            ...
                            <TableRow className="border-b last:border-b-0">
                                ...
                                <TableCell className={valueCellClass}>
                                    {formatRupiah(pengajuan.dana_maksimum)}
                                </TableCell>
                            </TableRow>
                ...
                <div className="w-full max-w-5xl flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[11px] text-muted-foreground">
                            Ketik angka saja, sistem akan otomatis menambahkan
                            tanda titik (contoh: 1000000 → 1.000.000).
                        </p>
                    </div>
